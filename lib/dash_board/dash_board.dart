            ...
            children: [
              ...
              SizedBox(
                ...
                SfCartesianChart(
                  ...
                  primaryYAxis: NumericAxis(edgeLabelPlacement: EdgeLabelPlacement.shift,
                      numberFormat: NumberFormat.simpleCurrency(decimalDigits: 1,name: 'B')
                  ),
                ...
                SfCartesianChart(
                  ...
                  primaryXAxis: CategoryAxis(),
                  primaryYAxis: NumericAxis(edgeLabelPlacement: EdgeLabelPlacement.shift,
                      numberFormat: NumberFormat.simpleCurrency(decimalDigits: 0,name: 'B')
                  ),
                  ...
                  TextButton(onPressed: (){
                    ...
                    if(!ScatterChart1){
                      ...
                      child:   Text(
                        'ربع ثانوي',
                        style: TextStyle(
                          color: !ScatterChart1?Colors.blueAccent:Colors.black,
                          fontSize: 20,
                          // fontFamily: FontWeight.w600
                        ),
                      )),
              ...
              SizedBox(
                ...
                SfCartesianChart(
                  ...
                  primaryXAxis: CategoryAxis(),
                  primaryYAxis: NumericAxis(edgeLabelPlacement: EdgeLabelPlacement.shift,
                      numberFormat: NumberFormat.simpleCurrency(decimalDigits: 1,name: '')
                  ),
                  ...
                  TextButton(onPressed: (){
                    ...
                    if(!ScatterChart2){
                      ...
                      child:   Text(
                        'ربع ثانوي',
                        style: TextStyle(
                          color: !ScatterChart2?Colors.blueAccent:Colors.black,
                          fontSize: 20,
                          // fontFamily: FontWeight.w600
                        ),
                      )),
